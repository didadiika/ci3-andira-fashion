...
class Barang_Masuk_Model extends CI_Model{
    ...
    var $tabel = "barang, masuk_brg";
    var $relasi = "barang.status_data = 'Aktif'";
    var $relasi1 = "barang.id_brg = masuk_brg.id_brg";
	var $pilih_kolom = array(
        "*");
	var $order_kolom = array(null, "masuk_brg.tanggal", "barang.nama_barang", "masuk_brg.jumlah", null);
    ...
    function tampil_data(){
		...
		{
			$this->db->group_start();
			$this->db->like("masuk_brg.tanggal", $_POST["search"]["value"]);
			$this->db->or_like("barang.nama_barang", $_POST["search"]["value"]);
			$this->db->or_like("masuk_brg.jumlah", $_POST["search"]["value"]);
			$this->db->group_end();
