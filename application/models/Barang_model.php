...
class Barang_Model extends CI_Model{
	...
	var $pilih_kolom = array(
        "barang.*");
	var $order_kolom = array(null, null, "kode_barang" , "nama_barang", "berat", null, "keterangan", null,null,null,null);
    ...
    function tampil_data(){
		...
		{
			$this->db->group_start();
            $this->db->like("kode_barang", $_POST["search"]["value"]);
			$this->db->or_like("nama_barang", $_POST["search"]["value"]);
			$this->db->or_like("berat", $_POST["search"]["value"]);
    ...
    function tampil_data_barang_keluar_dengan_id_keluar($id_keluar){
        $this->db->select("*");
        $this->db->from("keluar_brg,barang");
        $this->db->where("keluar_brg.id_brg = barang.id_brg");
        $this->db->where("keluar_brg.id_keluar = $id_keluar");
        $hasil = $this->db->get();
        return $hasil;
    }
