    ...
    <section class="content">
      <div class="box box-warning">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Pilih Periode Rekap Penjualan</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" action='<?php echo base_url('penjualan/laporan_penjualan_tampil');?>' method='post' target='_blank' autocomplete="off">
