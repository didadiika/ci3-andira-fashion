    ...
    <section class="content">
      <div class="box box-warning">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Pilih Periode Rekap Produksi</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" action='<?php echo base_url('produksi/laporan_produksi_tampil');?>' method='post' target='_blank' autocomplete="off">
