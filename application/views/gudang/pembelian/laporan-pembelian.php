...
<section class="content-header">
    ...
    <section class="content">
      <div class="box box-warning">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Pilih Periode Rekap Pembelian</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" action='<?php echo base_url('pembelian/laporan_pembelian_tampil');?>' method='post' target='_blank' autocomplete="off">
            

            
            <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Dari</label>
                  <select name="tgl1" id="tgl1"  required class="form-control">
    ...
    <select name="bln1" id="bln1" required class="form-control">
    ...
    <select name="thn1" id="thn1" required class="form-control">
