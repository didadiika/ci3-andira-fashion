...
<section class="content-header">
    ...
    <section class="content">
      <div class="box box-warning">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" action="<?php echo base_url('pembelian/pembelian_simpan'); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- text input -->
  ...
  {
    echo"<option value='$s->id_toko'>$s->nama_toko</option>";
  }
  ?>
    </select>
                  <span class="help-block" id="pesanNama"></span>
            ...
            <div id="tagNama" class="form-group">
                  ...
                  <input type="text" name="jenis_pembelian" id="jenis_pembelian" class="form-control" placeholder="Jenis Pembelian" required  maxlength="100" >
                  <span class="help-block" id="pesanNama"></span>
            </div>

            <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Total Belanja</label>
                  <input type="text" name="total" id="total" class="form-control" placeholder="Total Belanja" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this),hitungTotal();" value="0">
                  <span class="help-block" id="pesanNama"></span>
            </div>

            <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Bensin</label>
                  <input type="text" name="bensin" id="bensin" class="form-control" placeholder="Bensin" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this),hitungTotal();" value="0">
                  <span class="help-block" id="pesanNama"></span>
            </div>
