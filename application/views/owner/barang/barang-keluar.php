...
$(document).ready(function(){
  var table = $('#tabel-barang-keluar').DataTable({
     "language": {
        ...
        "order": [],
        "ajax": {
              url:"<?php echo base_url('barang/barang_keluar_tampil');?>",
              type:"POST",
        }
...
//GET HAPUS
$('#tabel-barang-keluar').on('click','.item_hapus',function(){
        ...
        $('#btn_hapus').on('click',function(){
          $('#btn_hapus').prop("disabled",true);
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('barang/barang_keluar_hapus/')?>"+id,
            data : {id: id},
...
<div class="box">
  <!--Tombol Tambah Data-->
            ...
            <div class="box-body">
              ...
              <table id="tabel-barang-keluar" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>No</th>
                  <th>Tanggal</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Barang Keluar</h4>
                    </div>
