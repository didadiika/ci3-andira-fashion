...
<section class="content-header">
    ...
    <section class="content">
      <div class="box box-warning">
        ...
        ?>
          <form role="form" action="<?php echo base_url('barang/barang_masuk_simpan'); ?>" method="post" autocomplete="off">
            <!-- text input -->
            ...
            <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Jumlah Masuk</label>
