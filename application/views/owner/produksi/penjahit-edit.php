<section class="content-header">
    ...
    <section class="content">
      <div class="box box-warning">
        ...
        <div class="box-body">
        <?php
        foreach($penjahit->result() as $r){
        ?>
          <form role="form" action="<?php echo base_url('produksi/penjahit_update/'.$this->uri->segment(4)); ?>" method="post" autocomplete="off">
            <!-- text input -->
            

            <div id="tagNama" class="form-group">
                  <label class="control-label" for="inputError"><i id="iconNama"></i> Nama Penjahit</label>
                  <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Penjahit"  required  maxlength="100" value="<?php echo $r->nama_penjahit;?>">
