...
<div class="login-box">
  ...
  <div class="alert alert-danger alert-dismissible">
      ...
      <h4><i class="icon fa fa-ban"></i> Peringatan!</h4>
                Masa berlaku program anda tinggal <strong> <?php echo $hari;?> Hari</strong> lagi. Hubungi penyedia hosting anda dan perpanjang hosting sebelum hangus. 
  </div>
  <?php } else if($hari < 0){ ?> 
  <div class="alert alert-danger alert-dismissible">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url("login/aksi_login");?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="username" class="form-control" placeholder="Username" required <?php if($hari < 0 ){echo "disabled";}?> >
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="Password" required <?php if($hari < 0 ){echo "disabled";}?>>
