      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($menu == "produksi"){echo "class='active treeview'";} else{echo "class='treeview'";}?>>
          ...
          <ul class="treeview-menu">
            <li <?php if($menu == "produksi" && $submenu == "kain"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/kain');?>"><i class="fa fa-circle-o"></i> Data Kain</a></li>
            <li <?php if($menu == "produksi" && $submenu == "pemotong"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/pemotong');?>"><i class="fa fa-circle-o"></i> Data Pemotong</a></li>
            <li <?php if($menu == "produksi" && $submenu == "penjahit"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/penjahit');?>"><i class="fa fa-circle-o"></i> Data Penjahit</a></li>
            <li <?php if($menu == "produksi" && $submenu == "produksi"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/produksi');?>"><i class="fa fa-circle-o"></i> Buat Produksi Baru</a></li>
            <li <?php if($menu == "produksi" && $submenu == "daftar_produksi"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/daftar_produksi');?>"><i class="fa fa-circle-o"></i> Daftar Produksi</a></li>
            <li <?php if($menu == "produksi" && $submenu == "laporan_produksi"){echo"class='active'";} ?>><a href="<?php echo base_url('produksi/laporan_produksi');?>"><i class="fa fa-circle-o"></i> Laporan Laba Produksi</a></li>
          </ul>
        </li>
        ...
        <li <?php if($menu == "pembelian"){echo "class='active treeview'";} else{echo "class='treeview'";}?>>
          ...
          <ul class="treeview-menu">
            <li <?php if($menu == "pembelian" && $submenu == "toko"){echo"class='active'";} ?>><a href="<?php echo base_url('pembelian/toko');?>"><i class="fa fa-circle-o"></i> Toko</a></li>
            <li <?php if($menu == "pembelian" && $submenu == "pembelian"){echo"class='active'";} ?>><a href="<?php echo base_url('pembelian/pembelian');?>"><i class="fa fa-circle-o"></i> Transaksi Pembelian</a></li>
        ...
        <li <?php if($menu == "barang"){echo "class='active treeview'";} else{echo "class='treeview'";}?>>
          ...
          <ul class="treeview-menu">
          <li <?php if($menu == "barang" && $submenu == "barang"){echo"class='active'";} ?>><a href="<?php echo base_url('barang/barang');?>"><i class="fa fa-circle-o"></i> Data Barang</a></li>
            <li <?php if($menu == "barang" && $submenu == "barang_masuk"){echo"class='active'";} ?>><a href="<?php echo base_url('barang/barang_masuk');?>"><i class="fa fa-circle-o"></i> Daftar Barang Masuk</a></li>
        ...
        <li <?php if($menu == "penjualan"){echo "class='active treeview'";} else{echo "class='treeview'";}?>>
          ...
          <ul class="treeview-menu">
            <li <?php if($menu == "penjualan" && $submenu == "pelanggan"){echo"class='active'";} ?>><a href="<?php echo base_url('penjualan/pelanggan');?>"><i class="fa fa-circle-o"></i> Pelanggan</a></li>
            <li <?php if($menu == "penjualan" && $submenu == "penjualan"){echo"class='active'";} ?>><a href="<?php echo base_url('penjualan/penjualan');?>"><i class="fa fa-circle-o"></i> Buat Penjualan Baru</a></li>
